    ...
    <div className="border rounded-xl bg-white">
      ...
      {favoriteData.length === 0 ? (
        <div className=" flex flex-col justify-center items-center min-h-[calc(100vh-7rem)]">
          <p className=" text-lg mb-4 text-gray-700">No liked GIFs yet. Start exploring and find your favorites!</p>
          <Button>
          <Link className="px-4 py-2 rounded-lg" href={'/explore'}>Explore GIFs</Link>
          </Button>
        </div>
      ) : (
